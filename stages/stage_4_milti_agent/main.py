...
async def privacy_agent(state: LegalState) -> dict:
    ...
    print("\n  [Node: privacy_agent] Privacy agent starting...")
    llm = get_llm()
...
QUESTION = "A tech startup with $5M revenue was caught sharing user data without consent and evaded taxes. What are the legal consequences?"
